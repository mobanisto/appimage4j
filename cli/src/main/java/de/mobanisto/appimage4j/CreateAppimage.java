...
public class CreateAppimage
{
	...
	public static ExeOptionsFactory OPTIONS_FACTORY = new ExeOptionsFactory() {
		...
		public ExeOptions createOptions()
		{
			...
			// @formatter:off
			OptionHelper.addL(options, OPTION_INPUT, true, true, "directory", "directory with app image content");
			OptionHelper.addL(options, OPTION_OUTPUT, true, true, "file", "app image executable");
			// @formatter:on
			...
			throws IOException
	{
		...
		Path appImageDir = Paths.get(input);
		Path fileAppImage = Paths.get(output);

		AppimageCreator task = new AppimageCreator(appImageDir, fileAppImage);
		task.execute();
	}
